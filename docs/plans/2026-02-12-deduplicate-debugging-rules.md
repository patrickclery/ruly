...
| `bug-investigation.md` | 241 | REDUNDANT (recipe loader, recipe handles this) |
| **TOTAL** | **11,966** | |
...
## Task 6: Delete `workaxle/recipes/bug-investigation.md` (241 tokens saved)

This is a recipe loader that just lists what modules to load. The recipe system (`core-debugger` recipe) already handles this — the recipe is redundant.

**Files:**
- Delete: `rules/workaxle/recipes/bug-investigation.md`
...
```bash
git rm rules/workaxle/recipes/bug-investigation.md
```

**Step 3: Commit**

```bash
git add rules/workaxle/recipes/bug-investigation.md recipes.yml
git commit -m "refactor: remove bug-investigation recipe (recipe handles loading)"
```
