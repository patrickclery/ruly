...
```yaml
  bug:
    ...
    files:
      ...
      # === Bug Investigation ===
      - /Users/patrick/Projects/ruly/rules/workaxle/recipes/bug-investigation.md
...
- The testing recipe (`workaxle/recipes/testing.md`) can be added to feature if its content is valuable
